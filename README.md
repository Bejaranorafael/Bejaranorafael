# Hola, soy Rafael 👋
Cloud Security / DevOps Support (Semi Senior). Me enfoco en automatización de CI/CD, administración de servidores, seguridad de plataforma (accesos, segmentación, hardening) y observabilidad.
...
## Experiencia
- Analista DevOps — 2024–Actualidad
  - Automatización de procesos y CI/CD en todo el ciclo de vida.
  - Administración de nodos Windows y pipelines en Jenkins.
  - Infraestructura en OpenShift y gestión de contenedores en AWS.
  - Soporte operativo a herramientas DevOps y repositorio de imágenes (Nexus).
- Analista DevOps — ICBC — 2023
  - Automatización de procesos, gestión de entrega continua y métricas.
  - Administración de servicios y colaboración con equipos técnicos para mejoras.
  - Stack: GitLab Pipelines, Docker, Kubernetes, Terraform, Grafana, AWS, OpenShift, Nexus.
- Sysadmin / Redes (contexto educativo) — 2017–2022
  - Conectividad y LAN para 3 edificios (switches/routers/cableado/access points).

## Habilidades clave
- Soporte N1/N2: troubleshooting, seguimiento de tickets y documentación (Jira).
- Seguridad y accesos: AD/Windows Server, políticas/roles, seguridad de red y firewalls.
- Cloud/DevOps: AWS, OpenShift/Kubernetes, Docker, Jenkins, GitLab CI/CD, Terraform, Nexus.
- Observabilidad: métricas y logs (Grafana, Elastic).
- Scripting: Bash, PowerShell, Python (automatización).
